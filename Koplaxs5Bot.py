...
def bot(op):
    ...
    #--------------- SC Add Admin ---------
              ...
              if owner == []:
                  cl.sendText(msg.to,"Owner Has Been Slain")
              else:
                  cl.sendText(msg.to,"Tunggu...")
    ...
    #--------------= SC Ganti nama Owner=--------------
              ...
              if msg.from_ in owner:
                ...
                if len(string.decode('utf-8')) <= 20:
                    ...
                    ow.sendText(msg.to,"Update Name Menjadi : " + string + "")
    #--------------= SC Ganti nama BOT=--------------
              ...
              if msg.from_ in owner:
                ...
                if len(string.decode('utf-8')) <= 20:
                    ...
                    profile.displayName = string
                    cl.updateProfile(profile)
                    cl.sendText(msg.to,"Laksmi Name Menjadi : " + string + "")
                ...
                #print wait2
                 ...
                 # if msg.from_ in admin:
                    if msg.to in wait2['readPoint']:
                        ...
                        cl.sendText(msg.to, "Ketik Cctv dulu Unch\nBaru Ketil Ciduk\nDASAR PEAK ♪")
#-----------------------------------------------
...
#-----------------------------------------------
    ...
    #-------------Fungsi Set Joined Battle of Ten Start---------------#
                ...
                if msg.from_ in admin:
                  print msg.from_
                  print "\n"
                  cl.sendText(msg.to,"==Battle of Ten di Grup ini==")
                  msg.contentType = 13
    ...
    #-------------Fungsi Set Joined Battle of Ten Finish---------------#
        ...
        #-------------Fungsi Say @ Start-----------------------#
            elif ".say bluff " in msg.text:
              if msg.from_ in owner:
                saytxt = msg.text.replace(".say bluff ","")
                get_name = saytxt.split(" ")
                arrlen = len(get_name)
                _name=""
                _bluff=" "
                _bluffend=""
        ...
        #-------------Fungsi Invite Battle of Ten Start-----------------------#
              ...
              if msg.from_ in admin:
                if saytxt == "s1":
                  cl.inviteIntoGroup(msg.to, ["ueff8f78401c867593c6ddc8aeb8c649d"])
                if saytxt == "s2":
                  cl.inviteIntoGroup(msg.to, ["u9fec89015e171bc9a8f82ce1ded83075"])
                if saytxt == "s3":
                  cl.inviteIntoGroup(msg.to, ["ubb4183ea6b5c541817eaa3e6a8c6acfe"])
        ...
        #-------------Fungsi Cek boten Mode Start-----------------------#
              ...
              if msg.from_ in admin:
                if wait["botenMode"] == True:
                  cl.sendText(msg.to, "Battle of Ten Mode ON Boss Quwh Unch")
                elif wait["botenMode"] == False:
                  cl.sendText(msg.to, "Battle of Ten Mode OFF Boss Quwh Unch")
        ...
        #-------------Fungsi Set boten Mode Start-----------------------#
              ...
              if msg.from_ in admin:
                if settxt == "on":
                  wait["botenMode"] = True
                  cl.sendText(msg.to, "Battle of Ten Mode udah di ON in Boss Quwh Unch")
                elif settxt == "off":
                  wait["botenMode"] = False
                  cl.sendText(msg.to, "Battle of Ten Mode udah di OFF in Boss Quwh Unch")
              ...
              if msg.from_ in admin:
                if wait["botenMode"] == True:
                  if wait["battleMode"] == True:
                    cl.sendText(msg.to, "Battle Mode untuk Battle of Ten Mode ON Boss Quwh Unch")
                  elif wait["battleMode"] == False:
                    cl.sendText(msg.to, "Summon Mode untuk Battle of Ten Mode ON Boss Quwh Unch")
                elif wait["botenMode"] == False:
                  cl.sendText(msg.to, "boten Mode nya di ON in dulu dong Boss Quwh Unch Unch")
              ...
              if msg.from_ in admin:
                if wait["botenMode"] == True:
                  if settxt == "on":
                    ...
                    cl.sendText(msg.to, "Battle Mode untuk Battle of Ten Mode udah di ON in Boss Quwh Unch")
                  elif settxt == "battle":
                    wait["battleMode"] = True
                    cl.sendText(msg.to, "DONE : Battle Mode untuk Battle of Ten Mode udah di ON in Boss Quwh Unch")
                    ki.sendText(msg.to, ".tagall_battle")
                    # time.sleep(5)
                    # cl.sendText(msg.to, "/battle")
                  elif settxt == "off":
                    wait["battleMode"] = False
                    cl.sendText(msg.to, "Battle Mode untuk Battle of Ten Mode udah di OFF in Boss Quwh Unch")
                  elif settxt == "summon":
                    wait["battleMode"] = False
                    cl.sendText(msg.to, "DONE : Summon Mode untuk Battle of Ten Mode udah di ON in Boss Quwh Unch")
        ...
        #-------------Fungsi Auto Join Battle Start-----------------------#
              ...
              cl.sendText(wait["joinedBoT"], (settxt))
      ...
      #----------------Selfbot debug Start-----------------#
              ...
              print "\n"
              if msg.from_ in admin:
                ow.sendText(msg.to,'Test Debug Ok')
                print msg
                print "\n"
...
#-----------------------------------------------
       ...
       #-------------Fungsi Respon Start---------------------#
              ...
              if msg.from_ in admin:
                cl.sendText(msg.to,"Tukang Kawin On")
      ...
      #-------------Fungsi Banned Send Contact Finish------------------#
              ...
              cl.sendMessage(msg)
              cl.sendText(msg.to,"======================")
              cl.sendText(msg.to,"Itu Creator Kami Yang Unch Unch")
              ...
              for adm in admin:
                ...
                cl.sendMessage(msg)
              cl.sendText(msg.to,"=======================================")
              cl.sendText(msg.to,"Itu Para Admin Yang Itteh Itteh Kimotih")
